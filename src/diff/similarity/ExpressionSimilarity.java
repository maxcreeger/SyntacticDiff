 ...
 *
 * @param <T> the Type of the {@link Expression}
 */
public class ExpressionSimilarity<T extends Expression> extends LeafSimilarity<T> {
    ...
    /**
     * Builds a comparison between two {@link Expression}, using the known similarity metric and size metric.
    ...
    public List<String[]> show(String prefix) {
        List<String> leftShow = exp1.show(prefix);
        List<String> rightShow = exp2.show(prefix);
