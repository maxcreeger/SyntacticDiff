...
public abstract class LeafSimilarity<S extends Showable> extends Similarity {
	...
	/**
	 * Builds a comparison between two objects, using the known similarity
	 * metric and size metric.
	 * 
	 * @param same
	 *            the similarity
	 * @param amount
	 ...
	 *            the right object
	 */
	public LeafSimilarity(String name, double same, int amount, S obj1, S obj2) {
		super(same, amount);
		this.name = name;
		this.obj1 = obj1;
		this.obj2 = obj2;
