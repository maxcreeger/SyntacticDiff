...
/**
 * Visitor of left-hand side {@link AbstractBlock}, that produces a specific
 * visitor for the right-hand side {@link AbstractBlock} to produce a
 * {@link Similarity}.
 */
public class AbstractBlockSimilarityEvaluator extends SimilarityEvaluator<AbstractBlock> {
	...
	public Similarity eval(AbstractBlock bloc1, AbstractBlock bloc2) {
		...
		if (similarity != null) { // Unimplemented methods may return null
			...
			return new LeafSimilarity<AbstractBlock>("Block", 0., AbstractBlockSizer.ABSTRACT_BLOCK_SIZER.size(bloc1, bloc2), bloc1, bloc2) {
				@Override
				public List<String[]> show(String prefix) {
					List<String> show1 = bloc1.fullBreakdown(prefix);
					List<String> show2 = bloc2.fullBreakdown(prefix);
