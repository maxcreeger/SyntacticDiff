...
public class ArrayInitializationSimilarityEvaluator extends SimilarityEvaluator<ArrayInitialization>
        implements
            ArrayInitializationVisitor<DualArrayInitializationComparator<? extends ArrayInitialization>> {
    ...
    public Similarity eval(ArrayInitialization array1, ArrayInitialization array2) {
        if (array1.getClass().equals(array2.getClass())) {
            ...
            return new LeafSimilarity<ArrayInitialization>(0., ArrayInitializationSizer.ARRAY_INITIALIZATION_SIZER.size(array1, array2), array1,
                    array2) {
