...
public class BooleanAnd extends BinaryOperator {
     ...
     * @param leftHandSide the lhs
     * @param rightHandSide the rhs
     */
    public BooleanAnd(Statement leftHandSide, Statement rightHandSide, CodeLocation location) {
     ...
     */
    public static Optional<BooleanAnd> build(Statement lhs, CodeBranch input) {
        ...
        return Optional.of(new BooleanAnd(lhs, rhs.get(), fork.commit()));
    }
