...
public class BooleanOr extends BinaryOperator {
     ...
     */
    public BooleanOr(Statement leftHandSide, Statement rightHandSide, CodeLocation location) {
     ...
     */
    public static Optional<BooleanOr> build(Statement lhs, CodeBranch input) {
        ...
        return Optional.of(new BooleanOr(lhs, rhs.get(), fork.commit()));
    }
