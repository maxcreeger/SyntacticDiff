...
public class Division extends BinaryOperator {
     ...
     */
    public Division(Statement leftHandSide, Statement rightHandSide, CodeLocation location) {
        super(leftHandSide, rightHandSide, location);
    }

    /**
     * Attempts to build a {@link Division}
     * @param lhs the left hand side
     * @param input the remaining text (is modified if the operator is built)
     * @return optionally, the operator
     */
    public static Optional<Division> build(Statement lhs, CodeBranch input) {
        ...
        return Optional.of(new Division(lhs, rhs.get(), fork.commit()));
    }
