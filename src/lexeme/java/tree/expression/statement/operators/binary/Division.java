...
public class Division extends BinaryOperator {
     ...
     */
    public Division(Statement leftHandSide, Statement rightHandSide) {
     ...
     */
    public static Optional<Division> build(Statement lhs, AtomicReference<String> input) {
        ...
        return Optional.of(new Division(lhs, rhs.get()));
    }
