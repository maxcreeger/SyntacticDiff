...
public class Equals extends BinaryOperator {
     ...
     */
    public Equals(Statement leftHandSide, Statement rightHandSide, CodeLocation location) {
     ...
     */
    public static Optional<Equals> build(Statement lhs, CodeBranch input) {
        ...
        return Optional.of(new Equals(lhs, rhs.get(), fork.commit()));
    }
