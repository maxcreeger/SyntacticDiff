...
public class Multiply extends BinaryOperator {
     ...
     */
    public Multiply(Statement leftHandSide, Statement rightHandSide, CodeLocation location) {
        super(leftHandSide, rightHandSide, location);
    }

    /**
     * Attempts to build a {@link Multiply}
     * @param lhs the left hand side
     * @param input the remaining text (is modified if the operator is built)
     * @return optionally, the operator
     */
    public static Optional<Multiply> build(Statement lhs, CodeBranch input) {
        ...
        return Optional.of(new Multiply(lhs, rhs.get(), fork.commit()));
    }
