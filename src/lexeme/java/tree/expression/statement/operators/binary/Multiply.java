...
public class Multiply extends BinaryOperator {
     ...
     */
    public Multiply(Statement leftHandSide, Statement rightHandSide) {
     ...
     */
    public static Optional<Multiply> build(Statement lhs, AtomicReference<String> input) {
        ...
        return Optional.of(new Multiply(lhs, rhs.get()));
    }
