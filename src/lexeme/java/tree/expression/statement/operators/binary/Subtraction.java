...
public class Subtraction extends BinaryOperator {
     ...
     */
    public Subtraction(Statement leftHandSide, Statement rightHandSide) {
     ...
     */
    public static Optional<Subtraction> build(Statement lhs, AtomicReference<String> input) {
        ...
        return Optional.of(new Subtraction(lhs, rhs.get()));
    }
