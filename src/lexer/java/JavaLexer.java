...
public class JavaLexer implements StructureLexer<JavaGrammar, Root> {
	...
	public static class JavaGrammar implements Grammar {
		...
		/** A class for single Words */
		@SuppressWarnings("unchecked")
		public static final Class<Symbol<JavaGrammar>> SINGLE_SYMBOL_CLASS = (Class<Symbol<JavaGrammar>>) new SymbolImpl<JavaGrammar>(null)	.getClass()
																																			.getInterfaces()[0];

		/** A class for single Words */
		@SuppressWarnings("unchecked")
		public static final Class<Whitespace<JavaGrammar>> SINGLE_WHITESPACE_CLASS = (Class<Whitespace<JavaGrammar>>) new Whitespace<JavaGrammar>().getClass();

		/** A class for sequence */
		@SuppressWarnings("unchecked")
		public static final Class<SequenceStructure<JavaGrammar>> SEQUENCE_CLASS = (Class<SequenceStructure<JavaGrammar>>) new SequenceStructure<JavaGrammar>().getClass();

		/** A class for repeated sequence */
		@SuppressWarnings("unchecked")
		public static final Class<RepeatStructure<JavaGrammar, SequenceStructure<JavaGrammar>>> REPEAT_SEQUENCE_CLASS = (Class<RepeatStructure<JavaGrammar, SequenceStructure<JavaGrammar>>>) new RepeatStructure<>(
			null).getClass();

		/** A class for repeated sequence */
		@SuppressWarnings("unchecked")
		public static final Class<OptionalStructure<JavaGrammar, SequenceStructure<JavaGrammar>>> OPTIONAL_SEQUENCE_CLASS = (Class<OptionalStructure<JavaGrammar, SequenceStructure<JavaGrammar>>>) new OptionalStructure<>(
			null).getClass();

		/** A class for optional sequence */
		@SuppressWarnings("unchecked")
		public static final Class<OptionalStructure<JavaGrammar, RepeatStructure<JavaGrammar, SequenceStructure<JavaGrammar>>>> OPTIONAL_REPEAT_STRUCTURE_CLASS = (Class<OptionalStructure<JavaGrammar, RepeatStructure<JavaGrammar, SequenceStructure<JavaGrammar>>>>) new OptionalStructure<>(
			null).getClass();

		/** Whitespace lexer. */
		public static final SingleWhitespaceStructureLexer<JavaGrammar> WHITESPACE_TOKEN_LEXER = new SingleWhitespaceStructureLexer<JavaGrammar>(token -> true);
