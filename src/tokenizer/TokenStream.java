...
public interface TokenStream<G extends Grammar> {
    ...
    /**
     * Request to find a particular {@link Token}. If found, advances the cursor and returns the token. If not found, returns an empty token.
     * 
    ...
    public static void main(String[] argc) {
        CodeBranch code = new CodeLocator("package java.com.truc;").branch();
        Optional<List<Token<JavaGrammar>>> tokens = JavaCodeTokenizer.TOKENIZER.tokenizeAll(code);
